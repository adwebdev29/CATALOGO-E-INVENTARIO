...
// 🟢 Importamos ArrowLeft y ArrowRight para los nuevos botones
    ...
    <section className="px-8 py-24 bg-white relative">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10">
          {" "}
          {/* Reduje un poco el margen inferior para que los botones se integren mejor */}
        ...
        {/* 🟢 NUEVOS CONTROLES DEL CARRUSEL (Siempre visibles, arriba a la derecha) */}
        <div className="flex justify-end gap-3 mb-6">
          <button
            onClick={() => handleScroll("left")}
            className="p-3 bg-[#f2f3ff] text-[#131b2e] hover:bg-[#131b2e] hover:text-white rounded-full transition-all duration-300 shadow-sm hover:shadow-md"
        ...
        <div className="text-center mt-12">
          <Link
            href="/catalogo"
            className="inline-flex items-center gap-2 border-2 border-[#004532] text-[#004532] px-10 py-4 font-bold text-xs tracking-widest uppercase hover:bg-[#004532] hover:text-white transition-all rounded-lg shadow-sm hover:shadow-md hover:-translate-y-0.5"
          >
