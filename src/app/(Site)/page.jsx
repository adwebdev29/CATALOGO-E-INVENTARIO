    ...
    <main className="pt-16">
      ...
      <section className="relative px-8 py-20 md:py-32 bg-white overflow-hidden border-b border-[#bec9c2]/10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* 🟢 Texto del Hero: Aparece de abajo hacia arriba */}
          <ScrollReveal direction="up" delay={0.1}>
            <div className="z-10 architectural-border pl-8">
              ...
              <p className="text-lg text-[#3f4944] mt-8 max-w-md leading-relaxed">
                Tecnología que se integra contigo: accesorios funcionales,
                diseño limpio y rendimiento confiable.
              </p>
          ...
          {/* 🟢 Imagen del Hero: Entra desde la derecha */}
          ...
          {displayCategorias.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {displayCategorias.map((cat, index) => {
                ...
                return (
                  // 🟢 Cada tarjeta aparece con un ligero retraso escalonado (index * 0.15)
                  <ScrollReveal
                    key={cat.nombre}
                    direction="up"
                    delay={index * 0.15}
                  >
                    <Link
                      ...
                      className={`group relative ${style.bgClass} p-10 h-[320px] flex flex-col justify-end hover:shadow-xl transition-all duration-300 rounded-xl cursor-pointer overflow-hidden block w-full`}
                    >
                      <div
      ...
      {/* 🟢 El slider principal completo aparece haciendo scroll */}
      ...
      <section className="px-8 py-32 bg-[#131b2e] text-white overflow-hidden relative border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20 relative z-10">
          {/* 🟢 Texto Promocional: Entra desde la izquierda */}
          <ScrollReveal direction="right" delay={0.2}>
            <div className="flex-1 architectural-border pl-10 border-[#004532]">
              ...
              <p className="mt-8 text-lg text-slate-400 leading-relaxed max-w-xl">
                ...
                eficiente. Buena calidad, buen diseño y desempeño confiable en
                el día a día.
              </p>

              <div className="block md:grid md:grid-cols-2 gap-12 mt-16">
                <div className="border-l border-white/10 pl-6 mb-8 md:mb-0">
          ...
          {/* 🟢 Imagen Promocional: Entra desde la derecha */}
