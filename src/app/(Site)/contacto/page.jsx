...
export default function Contacto() {
  ...
  return (
    <main className="pt-24 pb-20 max-w-7xl mx-auto px-6 sm:px-8 bg-[#faf8ff] text-[#131b2e] w-full flex-1 overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-7">
          <ScrollReveal direction="up" delay={0.1}>
            <div className="bg-white p-8 sm:p-10 rounded-xl shadow-[0_8px_24px_rgba(19,27,46,0.06)] relative overflow-hidden border border-[#bec9c2]/20">
          ...
          <ScrollReveal direction="up" delay={0.3}>
            <div className="group bg-white p-8 rounded-xl flex flex-col items-start hover:bg-[#f2f3ff] transition-all border border-[#bec9c2]/20 border-l-4 border-l-[#25D366] shadow-sm">
              ...
              <p className="text-sm text-[#3f4944] mb-6 leading-relaxed">
                Pregunta por precios, productos o recomendaciones, te atendemos
                al momento.
              </p>
              <a
